const projects = [
    {
        ...
        technologies: "Reach + Node",
        contributions: "N/A Followed professor's tutorial",
        ...
        github: 'https://github.com/WSPineda/CS3750-Portfolio/tree/main/project2',    },
    {
        ...
        contributions: "Created the whole assignment",
        image: "../../images/project_icon.png",
        link: "/project/3",
        github: 'https://github.com/WSPineda/CS3750-Portfolio/tree/main/project3',    },
    {
        ...
        description: "The Prerequisite for the Banking Application",
        long_description: "A solo project that became the banking application. To implement all four pieces of MERN in one functioning project. Also use sessions to track a user across pages in preparation for later assignments. Assignment overview: In a previous assignment, you created a handful of backend routes. Create a set of React frontend pages and components. Use those backend routes to make the website functional. Store session info/cookies in the Mongo Database, and not to memory or a plain text file",
        ...
        github: 'https://github.com/WSPineda/CS3750-Portfolio/tree/main/project4',    },
    {
        id: 5,
        title: "Hangman Game",
        description: "Write a Hangman game with two parts: game logic and high scores",
        long_description: "The user arrives at a website. The game asks the user for a name. After entering a name, the game starts. A traditional hangman game is shown with slots indicating the number of letters. The user makes a choice. If the letter exists, all those letters are shown. If the letter doesnt exist, the hangman progresses and the word is added to a visible list of incorrect letters. if the letter was previously chosen, inform the user of this and let the user try again. Upon fully guessing the word, that name is then stored into a scores table. Then a top 10 high scores table is displayed for all successful games with words of similar length. The high scores shows the name, the number of guesses, and the word length. If the word was not succesfully guessed with all allowed moves, then inform the user of the correct word. Then allow the user to go to the top 10 high scores table as previously described. After the high scores table is displayed, the game then asks if the user wishes to play again.",
        technologies: "In this project, we utilized the MERN stack, which includes MongoDB, Express.js, React.js, and Node.js, to build a robust and dynamic web application. MongoDB served as the NoSQL database, offering flexibility in data storage and easy scalability. Express.js and Node.js provided a strong backend foundation, enabling me to create RESTful APIs and manage server-side operations effectively. On the frontend, React.js was instrumental in developing a highly interactive and responsive user interface, leveraging components to build a seamless user experience. Bootstrap was integrated for styling, ensuring a modern, clean, and mobile-responsive design throughout the application.",
